...
public class Strategy8888464Task implements Runnable{

    private String taskInDate;

    public Strategy8888464Task(String taskInDate, StockCodeRepository stockCodeRepository, ScpoolRepository scpoolRepository, StkdjRepository stkdjRepository, HistorytradeInfoRepository historytradeInfoRepository, Helper helper) {
        super();
    ...
    public void run() {
        ...
        String startDate100DaysBeforeStr = helper.getStartDateStr360DaysBefore(taskInDate);
