...
public class Strategy881Task implements Runnable{

    private String taskInDate;

    public Strategy881Task(String taskInDate, StockCodeRepository stockCodeRepository, ScpoolRepository scpoolRepository, StkdjRepository stkdjRepository, HistorytradeInfoRepository historytradeInfoRepository, Helper helper) {
        super();
