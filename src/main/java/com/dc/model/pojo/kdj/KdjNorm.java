 ...
 *
 */
public class KdjNorm implements Norm {
	private static final KdjNorm KDJ = new KdjNorm();

	public static KdjNorm getInstance() {
		return KDJ;
	}
	...
	private double getBigDecimail(double d) {
