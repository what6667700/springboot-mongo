...
//        }
//
////        final List<T> entityList = mongoTemplate.find(query.addCriteria(criteria).with(new Sort(Collections.singletonList(new Order(Direction.ASC, ID)))), entityClass);
//
////        final List<T> entityList = mongoTemplate.find(query.addCriteria(criteria).with());
//
