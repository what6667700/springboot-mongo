...
@RestController
@RequestMapping("strategy781")
public class Monitor4ASC815_22_88781 {
	@Autowired
	...
	@RequestMapping(value = "/monitor781",method = RequestMethod.POST)
...
//								|| stkdj.getMacdh() < 0
	...
	public List<StockCode> firstStrategy()
	{
